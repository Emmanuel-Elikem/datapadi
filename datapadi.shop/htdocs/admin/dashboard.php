    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item"><a href="diagnostics.php"><i class="fas fa-stethoscope fa-fw"></i> System Health</a></li>
                <li class="menu-item"><a href="cron-logs.php"><i class="fas fa-file-alt fa-fw"></i> Cron Logs</a></li>
